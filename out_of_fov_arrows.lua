...
local enable = ui.new_checkbox(menu[1], menu[2], "Enable OOF arrows")
local custom_color = ui.new_color_picker(menu[1], menu[2], "OOF color", 50, 125, 255, 125)
local offscreen = ui.new_checkbox(menu[1], menu[2], "Only while offscreen")
...
--Wraps around yaw ie if yaw == 361 then it changes it to 1
